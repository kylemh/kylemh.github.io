...
$(".nav a").on("click",function(){$(".navbar-collapse").collapse("hide").click()}),$(".navbar-header a").on("click",function(){$(".navbar-collapse").collapse("hide").click()}),jQuery("img.svg").each(function(){var e=jQuery(this),a=e.attr("id"),t=e.attr("class"),r=e.attr("src");jQuery.get(r,function(r){var l=jQuery(r).find("svg");void 0!==a&&(l=l.attr("id",a)),void 0!==t&&(l=l.attr("class",t+" replaced-svg")),l=l.removeAttr("xmlns:a"),e.replaceWith(l)},"xml")}),function(e,a,t,r,l,i,c,n,o){try{for(c=e.getElementsByTagName("a"),o=e.createElement("textarea"),r=0;c.length-r;r++)try{if(t=c[r].href,a=t.indexOf("/cdn-cgi/l/email-protection"),n=t.length,t&&a>-1&&n>28){if(l=28+a,a="",l<n){for(i="0x"+t.substr(l,2)|0,l+=2;l<n&&"X"!=t.charAt(l);l+=2)a+="%"+("0"+("0x"+t.substr(l,2)^i).toString(16)).slice(-2);l++,a=decodeURIComponent(a)+t.substr(l,n-l)}o.innerHTML=a.replace(/</g,"&lt;").replace(/>/g,"&gt;"),c[r].href="mailto:"+o.value}}catch(e){}}catch(e){}}(document),function(e){"use strict";e("a.page-scroll").bind("click",function(a){var t=e(this);e("html, body").stop().animate({scrollTop:e(t.attr("href")).offset().top-50},1250,"easeInOutExpo"),a.preventDefault()}),e("body").scrollspy({target:".navbar-fixed-top",offset:51}),e(".navbar-collapse ul li a").click(function(){e(".navbar-toggle:visible").click()}),e("#mainNav").affix({offset:{top:100}}),window.sr=ScrollReveal(),sr.reveal(".sr-icons",{duration:600,scale:.3,distance:"0px"},200),sr.reveal(".sr-button",{duration:1e3,delay:200}),sr.reveal(".sr-contact",{duration:600,scale:.3,distance:"0px"},300),e(".popup-gallery").magnificPopup({delegate:"a",type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.'}})}(jQuery);