...
$(".nav a").on("click",function(){$(".navbar-collapse").collapse("hide").click()}),$(".navbar-header a").on("click",function(){$(".navbar-collapse").collapse("hide").click()}),jQuery("img.svg").each(function(){var e=jQuery(this),t=e.attr("id"),a=e.attr("class"),c=e.attr("src");jQuery.get(c,function(c){var r=jQuery(c).find("svg");void 0!==t&&(r=r.attr("id",t)),void 0!==a&&(r=r.attr("class",a+" replaced-svg")),r=r.removeAttr("xmlns:a"),e.replaceWith(r)},"xml")}),function(e,t,a,c,r,i,l,n,o){try{for(l=e.getElementsByTagName("a"),o=e.createElement("textarea"),c=0;l.length-c;c++)try{if(a=l[c].href,t=a.indexOf("/cdn-cgi/l/email-protection"),n=a.length,a&&t>-1&&n>28){if(r=28+t,t="",r<n){for(i="0x"+a.substr(r,2)|0,r+=2;r<n&&"X"!=a.charAt(r);r+=2)t+="%"+("0"+("0x"+a.substr(r,2)^i).toString(16)).slice(-2);r++,t=decodeURIComponent(t)+a.substr(r,n-r)}o.innerHTML=t.replace(/</g,"&lt;").replace(/>/g,"&gt;"),l[c].href="mailto:"+o.value}}catch(e){}}catch(e){}}(document),function(e){"use strict";e("body").scrollspy({target:".navbar-fixed-top",offset:51}),e(".navbar-collapse ul li a").click(function(){e(".navbar-toggle:visible").click()}),e("#mainNav").affix({offset:{top:100}})}(jQuery);